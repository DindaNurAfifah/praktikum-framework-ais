...
def student_index(request):
    ...
    return render(request, 'student/index.html', {
        'students': students,  # Tampilkan data mahasiswa dari API
        'query': query  # Kirim query ke template jika ada
    })
...
def student_update(request, student_id):
    ...
    # Tampilkan form dengan data mahasiswa yang sudah ada
    return render(request, 'student/update.html', {
        'form': StudentsForm(initial=student),
        'student': student
    })
